...
import 'package:iship/Basicscreen.dart';
import 'package:iship/Breathingscreen.dart';
import 'package:iship/Namaskarscreen.dart';
import 'package:iship/Weightscreen.dart';

void main() {
  runApp(DevicePreview(builder: (context) => YogaApp()));
}
